...
from adventofcode.util.input_helpers import _get_input, _read_file, get_input_for_day, get_input_for_day_as_str
...
def test_get_input_for_day(mocker: pytest_mock.MockerFixture):
    ...
    mock_get_input.assert_called_with("dir/solutions/year_2020/day_01.txt")
...
def test_get_input_for_day_as_str(mocker: pytest_mock.MockerFixture):
    ...
    assert "c0ffee\ncafe" == data
    mock_read_file.assert_called_with("dir/solutions/year_2020/day_01.txt")
